...
function PlayerProfile() {
  const player = {
    ...
    name: "Player Bio", 
    bioCategories: [
      { title: "Class", description: "2025" },
      { title: "Position", description: "WR/ATH" },
      { title: "Height", description: "6'3\"" },
      { title: "Weight", description: "217 lbs" },
      { title: "Place of Birth", description: "San Antonio, TX" },
      { title: "High School", description: "Alamo Heights High School" },
    ],
  };
          ...
          <Grid gap={4}>
            {player.bioCategories.map((category, index) => (
              <Box key={index} p={3} bgColor="transparent" borderRadius="8px">
                <Text color="#000000" fontWeight="bold" fontFamily="'Bungee', sans-serif" fontSize="lg">
                  {category.title}
                </Text>
                <Text color="#000000" fontFamily="'Titillium Web', sans-serif" fontSize="lg" fontWeight="semibold" mt={1}>
